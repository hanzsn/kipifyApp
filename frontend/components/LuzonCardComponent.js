class LuzonCardComponent extends HTMLElement {
  connectedCallback() {
    const name = this.getAttribute("name") || "Luzon Destination";
...
customElements.define("luzon-card", LuzonCardComponent);
