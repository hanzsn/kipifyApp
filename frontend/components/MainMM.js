class MainMMComponent extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `<main class="bot relative z-10 flex justify-center h-full w-full">
        ...
        <div class="h-[50vh] flex items-center w-full px-10 left-text z-10">
            <h1 class="text-5xl sm:text-6xl font-semibold tripify-font">Mindanao Region Destinations</h1>
        </div>
    </main>`;
  }
}

customElements.define("app-mainmm", MainMMComponent);
