// VisayasCardComponent.js
class VisayasCardComponent extends HTMLElement {
  connectedCallback() {
    const name = this.getAttribute("name") || "Visayas Destination";
...
customElements.define("visayas-card", VisayasCardComponent);
